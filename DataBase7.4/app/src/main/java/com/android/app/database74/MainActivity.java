package com.android.app.database74;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        empFirstName = new String[]{"Shruti", "Santosh", "Shraddha", "Megha", "Manju"};
        empLastName = new String[]{"abc","def","ijk","lmn","opq"};
        empAge = new String[]{"24","28","25","27","29"};
        empSex = new String[]{"Female","Male","Female","Female","Male"};
